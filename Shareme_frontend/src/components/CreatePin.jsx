...
const CreatePin = ({user}) => {
    ...
    const [displayInvalidFieldsWarning, setDisplayInvalidFieldsWarning] = useState(false);
  ...
  const createPin = () => {
    if (isFormDataValid) {
      ...
      setDisplayInvalidFieldsWarning(true);
      setTimeout(() => {
        setDisplayInvalidFieldsWarning(false);
      }, 2000);
    }
  };
